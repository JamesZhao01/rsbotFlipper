...
import controller.connections.AutomaticUpdater;
...
import controller.GrandExchangeInteractionUtils;
import common.Globals;
import gui.Cli;
import gui.mouse.MouseCursor;
import gui.mouse.MouseTrail;
import logger.ScriptLoggers;
...
public class Driver extends Script {
    ...
    public void onStart() {
        InputStream in = null;
        try {
            in = this.getDataResourceAsStream("./logger.properties");
...
//        automaticUpdater = new AutomaticUpdater(connectionHandler);
    ...
    public void onExit() {
        cli.dispose();
        scriptLogger.info("Cli gui destroyed");
    }
    ...
    private void initializeUI() {
        ...
        cli.setVisible(true);
        scriptLogger.info("Cli gui displayed");
