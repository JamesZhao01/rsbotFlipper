package com.jameszhao.rsbotFlipper.server;


public class DataApiImpl {
//    private MainServer mainServer;
//    private CommandParser com.jameszhao.rsbotFlipper.parser;
//
//    public DataApiImpl(DataHandler dataHandler, MainServer mainServer){
//        this.mainServer = mainServer;
//        com.jameszhao.rsbotFlipper.parser = new CommandParser(dataHandler, mainServer);
//    }
//
//    @Override
...
//        String msg;
//        try {
//            msg = com.jameszhao.rsbotFlipper.parser.parseAndRun(request.getCommand());
