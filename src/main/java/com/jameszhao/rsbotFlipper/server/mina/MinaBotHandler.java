...
public class MinaBotHandler extends IoHandlerAdapter {
     ...
     *
     * @param server the com.jameszhao.rsbotFlipper.server reference
     */
...
//
//                    BotResponse response = com.jameszhao.rsbotFlipper.server.initializeNewBot(connect.getBotName(), connect.getStatusUpdate());
//
...
//                com.jameszhao.rsbotFlipper.server.setData(u);
//                break;
//        }
    }
